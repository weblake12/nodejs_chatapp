...
<script>
    ...
    $(function() {
        ...
        socket.on('receive_message', function(data) {
            ...
            console.log(data);
            console.log('!! right');
            console.log((parseInt(data.user_id) == user_id && parseInt(data.user_other_id) == other_user_id));
            console.log('!! left');
            console.log((parseInt(data.user_id) == other_user_id && parseInt(data.user_other_id) == user_id));
